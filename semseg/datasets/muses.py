...
class MUSES(Dataset):
    ...
    def __init__(self, root: str = './muses/multimodal', split: str = 'train', transform=None, modals=['frame_camera'], weather_condition=None, time_of_day=None) -> None:
        super().__init__()
    ...
    def __getitem__(self, index: int) -> Tuple[Tensor, Tensor]:
        ...
        for modal in self.modals:
            ...
            if modal == 'frame_camera':
                sample['img'] = img_tensor
            elif modal == 'event_camera':
                sample['event'] = img_tensor
            elif modal == 'lidar':
                sample['lidar'] = img_tensor
        ...
        modal_name = {'frame_camera': 'img', 'event_camera': 'event', 'lidar': 'lidar'}
        sample = [sample[modal_name[k]] for k in self.modals]
